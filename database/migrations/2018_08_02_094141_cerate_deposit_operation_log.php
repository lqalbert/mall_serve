...
class CerateDepositOperationLog extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deposit_operation_log', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('deposit_operation_log');
    }
}
