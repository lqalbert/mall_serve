...
Route::group(['prefix'=>'admin', 'namespace' => 'Admin', 'domain' => env('ADMIN_DOMAIN', 'admin.mall')], function(){
    ...
    Route::group(['prefix'=>'admin', 'namespace' => 'Admin', 'middleware'=>'auth.basic', 'domain' => env('ADMIN_DOMAIN', 'admin.mall')], function(){
