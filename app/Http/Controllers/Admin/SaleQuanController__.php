...
ET;
        ...
        $result = DB::connection('mysql_read')->select($sql, array_merge($binds));
        dd($result);
...
ET;
        ...
        if($request->has('department_id')){
            ...
            $where_str_ .=" and cu.department_id = :maintable_department_id ";
        }
        
        if($request->has('group_id')){
            $binds['maintable_group_id'] =  $request->input('group_id');
            $where_str_ .=" and cu.group_id = :maintable_group_id ";
        }
